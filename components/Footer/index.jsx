        ...
        <footer>
            <section className="section">
                <div className="sub-section-1">
                    ...
                    <div className="flex-row col-gap-8 margin-top-40">
            ...
            <section className="section">
                <div className="flex-col row-gap-16 text-md">
                    <h3 className="text-bold">mettā muse</h3>
                    <a href="#">About us</a>
                    <a href="#">Stories</a>
                    <a href="#">Artisans</a>
                    <a href="#">Boutiques</a>
                ...
                <div className="flex-col row-gap-16 text-md">
                    <h3 className="text-bold">QUICK LINKS</h3>
                ...
                <div className="flex-col row-gap-16">
                    ...
                    <h3 className="text-bold margin-top-40">mettā muse ACCEPTS</h3>
                    <div className="flex-row col-gap-8">
